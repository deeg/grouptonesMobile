...
module.exports = function (server, passport, connection, crypto) {
    ...
    server.get('/faq', ensureAuthenticated, function(req, res){
        res.render('faq.dust');
    })

    server.get('/contact', ensureAuthenticated, function(req, res){
        res.render('contact.dust');
    })

    server.post('/contact', ensureAuthenticated, function(req, res){
